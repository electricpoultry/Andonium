...
object ModItems {
    ...
    val Andonium_Axe: DeferredItem<AxeItem> = ITEMS.register("andonium_axe", Supplier { AxeItem(ModToolTiers.ANDONIUM_AXE, 6.0f, -2.0f, Item.Properties().setId(ResourceKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(MOD_ID, "andonium_axe"))).rarity(Rarity.EPIC).axe(ModToolTiers.ANDONIUM_AXE, 6.0f, -2.0f)) })
