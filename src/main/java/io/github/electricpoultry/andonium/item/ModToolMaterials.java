...
public enum ModToolMaterials implements ToolMaterial {
    ANDONIUM_PICKAXE(ModTags.Blocks.INCORRECT_FOR_ANDONIUM_TOOL,
            3300, 65f, 6f, 58, () -> Ingredient.ofItems(ModItems.ANDONIUM)),

    ANDONIUM_AXE(ModTags.Blocks.INCORRECT_FOR_ANDONIUM_TOOL,
            3300, 65f, 6f, 58, () -> Ingredient.ofItems(ModItems.ANDONIUM));;
